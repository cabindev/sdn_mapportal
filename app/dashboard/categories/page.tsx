      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          <div className="flex items-center mb-4 sm:mb-0">
            ...
            <div>
              <h1 className="text-2xl font-light text-slate-900">ประเภทเอกสาร</h1>
          ...
          <Link
            ...
            className="inline-flex items-center px-4 py-2 bg-slate-900 text-white text-sm font-light rounded-lg hover:bg-slate-800 transition-colors shadow-sm"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-xl border border-slate-200/50 p-6 shadow-sm">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-light text-slate-600">ประเภททั้งหมด</p>
                <p className="text-3xl font-light text-slate-900">{categories.length.toLocaleString()}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200/50 p-6 shadow-sm">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-light text-slate-600">ประเภทที่ใช้งาน</p>
          ...
          <div className="bg-white rounded-xl border border-slate-200/50 p-6 shadow-sm">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-light text-slate-600">ประเภทว่าง</p>
        ...
        <div className="bg-white rounded-xl border border-slate-200/50 shadow-sm overflow-hidden">
          {categories.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-sm font-light text-slate-600 mb-6 max-w-md mx-auto">
        ...
        {categories.length > 0 && (
          <div className="mt-8 bg-slate-50 rounded-xl p-6 border border-slate-200/50">
            <h3 className="text-sm font-medium text-slate-900 mb-3">คำแนะนำการจัดการประเภทเอกสาร</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm font-light text-slate-600">
              <div>
                <p className="font-medium text-slate-700 mb-2">การตั้งชื่อประเภท:</p>
              ...
              <div>
                <p className="font-medium text-slate-700 mb-2">การจัดการ:</p>
                <ul className="space-y-1 text-xs list-disc list-inside">
