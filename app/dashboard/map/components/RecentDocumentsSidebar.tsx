...
export default function RecentDocumentsSidebar({ 
  ...
  return (
    <>
      <div className="absolute top-1/2 transform -translate-y-1/2 left-24 bg-white/95 rounded-lg shadow-lg overflow-hidden z-[900] w-80 max-h-[calc(100vh-100px)] hidden md:block">
        <div className="px-3 py-2.5 bg-blue-100 border-b border-blue-200 flex items-center justify-between">
