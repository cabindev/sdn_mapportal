...
// นำเข้า DocumentPopup
import DocumentPopup from "./DocumentPopup";

interface RecentDocumentsSidebarProps {
 documents: DocumentWithCategory[];
 onHoverDocument?: (documentId: number | null) => void;
 defaultCenter?: [number, number]; // ตำแหน่งเริ่มต้นของแผนที่
 defaultZoom?: number; // ระดับซูมเริ่มต้น
}

export default function RecentDocumentsSidebar({ 
 documents: allDocuments, 
 onHoverDocument,
 defaultCenter = [13.7563, 100.5018], // ค่าเริ่มต้นคือกลางประเทศไทย
 defaultZoom = 6 // ระดับซูมเริ่มต้นที่เห็นประเทศไทยทั้งหมด
 ...
 return (
   <>
     <div className="absolute top-1/2 transform -translate-y-1/2 left-24 bg-white/90 backdrop-blur-sm rounded-lg shadow-lg overflow-hidden z-[900] w-80 max-h-[calc(100vh-100px)] hidden md:block">
     ...
     {/* ใช้ DocumentPopup component แทนการเขียน HTML ตรงๆ */}
