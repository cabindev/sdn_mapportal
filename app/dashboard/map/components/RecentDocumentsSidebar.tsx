...
export default function RecentDocumentsSidebar({ 
  ...
  return (
    <>
      <div className="absolute top-4 left-24 bg-white/90 backdrop-blur-sm rounded-lg shadow-lg overflow-hidden z-[900] w-72 max-h-[calc(100vh-150px)] hidden md:block">
